...
const Text = (props) => {
  ...
  return (
    <div
      className="container">
            {reportData.length&&reportData[0].survey_sections.map((v1, k1) => (
              <div key={k1} className="container text-dark" style={{
                ...
                >
                  {v1.questions
                    ? v1.questions.map((v2, k2) => (
                        <div key={k2} className="col-lg-6" style={{
                          ...
                          v2.input_type_id === 6 ? null : (
                            <div className="d-flex flex-row flex-wrap">
                              ...
                              <div className="w-50">
                                - {isNaN(NotAnswered(v2.totalAnsCount, TotalBuilding))?0:NotAnswered(v2.totalAnsCount, TotalBuilding)}{" "}
                                (
                                {isNaN(Percentage(
