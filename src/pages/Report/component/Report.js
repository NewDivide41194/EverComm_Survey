    ...
    survey_sections: [
      {
        ...
        Questions: [
          ...
          },
          {
            question_id: 5,
            question_name:
              "Do you have building management system installed(BMS)?",
            Answers: [
              {
      ...
      },
      {
        ...
        Questions: [
          ...
          },
          {
            question_id: 14,
            question_name:
              "Please select ther cooling rationale of Condenser #1?",
            Answers: [
              {
      ...
      },
      {
        ...
        Questions: [
          ...
          },
          {
            question_id: 25,
            question_name:
              "Please select the cooling rationale of Evaporator #1?",
            Answers: [
              {
                option_choice_name: "Water-cooled",
                totalAns: 2,
          ...
          },
          {
            question_id: 31,
            question_name:
              "Please select the cooling rationale of Evaporator #2?",
            Answers: [
              {
                option_choice_name: "Water-cooled",
                totalAns: 1,
