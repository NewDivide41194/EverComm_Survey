    ...
    surveyData.length && (
      <div>
        ...
        <div className="container">
          ...
          >
            <div className="font-weight-bold">{surveyData[0].survey_sections[pageno].section_name}</div>
            <div>{Object.values(amountOfDevice[0])[pageno-1]} {Object.keys(amountOfDevice[0])[pageno-1]}</div>  
          </div>
